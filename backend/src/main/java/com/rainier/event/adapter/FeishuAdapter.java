...
/**
 * v0.0.66 — 飞书 {@link EventExtractor} stub. Matches sourceType="FEISHU" but {@code extract}
 * always returns empty.
 */
@Component
public class FeishuAdapter implements EventExtractor {

  @Override
  public boolean supports(Event event) {
    return event != null && "FEISHU".equals(event.getSourceType());
  }
